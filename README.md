...
Esta guía te lleva desde cero hasta tener el entorno funcionando y entender el flujo básico de la aplicación. Para el detalle de arquitectura y dominio, consulta [`docs/`](./docs); para configurar la revisión automática de docs en los PR, [`docs/ci/tokens-github-actions.md`](./docs/ci/tokens-github-actions.md).
